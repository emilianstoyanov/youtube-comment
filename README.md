...
2. [🔹 🛠 Инсталация и настройка](#инсталация-и-настройка)
   ...
   - [3️⃣ Създаване на .env файл с креденшъли](#2️⃣-създаване-на-env-файл)
   - [4️⃣ Създаване на база данни (PostgreSQL)](#3️⃣-създаване-на-база-данни)
   - [5️⃣ Генериране на YouTube API OAuth 2.0 Client ID](#4️⃣-генериране-на-youtube-api-oauth-20-client-id)
