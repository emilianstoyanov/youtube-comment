...
3. [🔹 Инсталация и настройка](#инсталация-и-настройка)
   ...
   - [2️⃣ Създаване на .env файл](#2️⃣-създаване-на-env-файл)
   - [3️⃣ Създаване на база данни](#3️⃣-създаване-на-база-данни)
   - [4️⃣ Генериране на YouTube API OAuth 2.0 Client ID](#4️⃣-генериране-на-youtube-api-oauth-20-client-id)
   - [5️⃣ Настройка на Telegram бота](#5️⃣-настройка-на-telegram-бота)
4. [🔹 Команди в Telegram](#команди-в-telegram)
5. [🔹 Потенциални грешки и решения](#потенциални-грешки-и-решения)
6. [🔹 Лиценз и поддръжка](#лиценз-и-поддръжка)
